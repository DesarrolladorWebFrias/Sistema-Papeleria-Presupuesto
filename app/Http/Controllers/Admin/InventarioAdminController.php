...
class InventarioAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.inventarios.index', compact('categorias'));
    }
         ...
         if ($request->ajax()) {
            $data = Productos::where('estatus_id', 1)->get();
             return Datatables::of($data)
                    ...
                    ->addIndexColumn()
                    ->addColumn('btn', 'admin.inventarios.opciones')
                    ->rawColumns(['btn'])
                    ->make(true);
         } 
    }
    ...
    public function show($id)
    {
       ...
       return view('admin.inventarios.mostrar', compact('productos','details'));  
    }
