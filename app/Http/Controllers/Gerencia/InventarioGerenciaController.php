...
class InventarioGerenciaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('gerencia.inventarios.index', compact('categorias'));
    }
         ...
         if ($request->ajax()) {
            $data = Productos::where('estatus_id', 1)->get();
             return Datatables::of($data)
                    ...
                    ->addIndexColumn()
                    ->addColumn('btn', 'gerencia.inventarios.opciones')
                    ->rawColumns(['btn'])
                    ->make(true);
         } 
    }
    ...
    public function show($id)
    {
       ...
       return view('gerencia.inventarios.mostrar', compact('productos','details'));  
    }
