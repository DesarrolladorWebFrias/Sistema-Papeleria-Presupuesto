...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gerencia.presupuesto.index', compact('prespstorzda','prespstoaut','prespstorech'));
    }
        ...
        if ($request->ajax()) {
            $data = Presupuesto::where('estatus_presupuesto', 1)->get();
             return Datatables::of($data)
                    ...
                    ->addIndexColumn()
                    ->addColumn('btn', 'gerencia.presupuesto.opciones')
                    ->rawColumns(['btn'])
                    ->make(true);
         } 
    }
    ...
    public function show($id)
    {
        ...
        return view('gerencia.presupuesto.mostrar', compact('presupuesto','details'));
    }
