<div class="flex justify-center items-center">
    ...
    <a class="flex items-center text-theme-6" href="{{ route('inventario.show', $id) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Mostrar Movimientos </a>
    <!-- 
	...
	-->
    @include('almacenista.inventarios.edit')
</div>