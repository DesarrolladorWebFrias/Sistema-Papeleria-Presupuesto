<div class="modal" id="edit-inventarios{{$id}}">
    <div class="modal__content modal__content--xl">
        ...
        {!! Form::open(['route' => ['inventario.update', $id], 'method' => 'PUT']) !!}
        {{ csrf_field() }}
        ...
        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            <div class="col-span-12 sm:col-span-2 @if ($errors->has('clave')) has-error @endif">
                ...
                <input type="text" class="input w-full border mt-2 flex-1" name="clave" id="clave"  value="{{$clave}}"aria-describedby="helpClave">
