...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#compras_realizadas').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('almacenista.presupuesto.presupuestoscreados') }}",
        columns: [
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#compras_autorizadas').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('almacenista.presupuesto.presupuestosautorizado') }}",
        columns: [
            {data: 'id', name: 'id', class:"border-b"},
            {data: 'descripcion', name: 'descripcion', class: "text-center border-b"},
            {data: 'estatuspresupuesto', name: 'estatuspresupuesto', class: "text-center border-b"},
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#presupuesto_rechazados').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('almacenista.presupuesto.presupuestosrechazados') }}",
        columns: [
            {data: 'id', name: 'id', class:"border-b"},
            {data: 'descripcion', name: 'descripcion', class: "text-center border-b"},
            {data: 'estatuspresupuesto', name: 'estatuspresupuesto', class: "text-center border-b"},
