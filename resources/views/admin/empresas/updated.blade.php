<div class="modal" id="edit-empresas{{ $id}}">
    <div class="modal__content modal__content--xl">
        <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
            <h2 class="font-medium text-base mr-auto">
                Actualizacion del centro de trabajo {{$nombre}}
            </h2>
        ...
        {!! Form::open(['route' => ['empresa.update', $id], 'method' => 'PUT']) !!}
        {{ csrf_field() }}
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                <div class="col-span-12 sm:col-span-3 @if ($errors->has('nombre')) has-error @endif">
                    ...
                    <input type="text" class="input w-full border mt-2 flex-1" name="nombre" id="nombre" value="{{ $nombre }}" aria-describedby="helpNombre">
                ...
                <div class="col-span-12 sm:col-span-3 @if ($errors->has('telefono')) has-error @endif">
                    ...
                    <input type="number" class="input w-full border mt-2 flex-1" name="telefono" id="telefono" value="{{ $telefono }}" aria-describedby="helpTelefono">
                ...
                <div class="col-span-12 sm:col-span-3 @if ($errors->has('rfc')) has-error @endif">
                    <label class="font-medium text-base mr-auto" for="rfc">RFC</label>
                    <input type="text" class="input w-full border mt-2 flex-1" name="rfc" id="rfc" value="{{ $rfc }}" aria-describedby="helpRfc">
                ...
                <div class="col-span-12 sm:col-span-3 @if ($errors->has('direccion')) has-error @endif">
                    ...
                    <input type="text" class="input w-full border mt-2 flex-1" name="direccion" id="direccion" value="{{ $direccion }}" aria-describedby="helpDireccion">
