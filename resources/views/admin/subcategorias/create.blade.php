<div class="modal" id="crear_subcategorias">
    <div class="modal__content modal__content--xl">
        <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
            <h2 class="font-medium text-base mr-auto">
                Crear nueva ubcategorias
            </h2>
            <!--
        ...
        <form method="POST" action="{{ route('subcategorias.store') }}"  role="form">
            ...
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                ...
                <div class="col-span-12 sm:col-span-6 @if ($errors->has('categorias_id')) has-error @endif">
                    <label class="font-medium text-base mr-auto" for="categorias_id">Nombre de la categoria:</label>
