    ...
    <h2 class="font-medium text-base mr-auto">
      Compras realizadas
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
         <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('compra.create') }}">Crear nueva compras</a>
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#compras_realizadas').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('admin.inventario.compras.realizadas') }}",
        columns: [
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#compras_autorizadas').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('admin.inventario.compras.autorizadas') }}",
       columns: [
            {data: 'id', name: 'id', class:"border-b"},
            {data: 'descripcion', name: 'descripcion', class: "text-center border-b"},
            {data: 'formadepago', name: 'formadepago', class: "text-center border-b"},
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#campras_rechazadas').DataTable({
          processing: true,
          serverSide: true,
        ajax: "{{ route('admin.inventario.compras.rechazadas') }}",
        columns: [
            {data: 'id', name: 'id', class:"border-b"},
            {data: 'descripcion', name: 'descripcion', class: "text-center border-b"},
            {data: 'formadepago', name: 'formadepago', class: "text-center border-b"},
