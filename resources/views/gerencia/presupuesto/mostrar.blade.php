...
<div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="javascript:;" data-toggle="modal" data-target="#edit-productos{{$detail->id}}" value="{{$detail->id}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Editar </a>
                                     <form action="{{action('Gerencia\AutorizarController@destroy', $detail->id)}}" method="post">
								    	{{csrf_field()}}
                                 ...
                                 @include('gerencia.presupuesto.edit')
                            </td>
    ...
    <div class="col-span-12 sm:col-span-2">  
        <a href="/gerencia/dashboard" class="button w-32 mr-2 mb-2 flex items-center justify-center border text-gray-700"> <i data-feather="hard-drive" class="w-4 h-4 mr-2"></i> Regresar</a> 
    </div>
    @if($presupuesto->estatus_presupuesto == 1)
    <div class="col-span-12 sm:col-span-2">
        <a href="/gerencia/autorizar/{{$presupuesto->id}}/2" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white"> <i data-feather="activity" class="w-4 h-4 mr-2"></i> Autorizar</a> 
    </div>
    <div class="col-span-12 sm:col-span-2">
        <a href="/gerencia/autorizar/{{$presupuesto->id}}/4" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-6 text-white"> <i data-feather="trash" class="w-4 h-4 mr-2"></i> Rechazar</a> 
    </div>
    @endif
@endsection